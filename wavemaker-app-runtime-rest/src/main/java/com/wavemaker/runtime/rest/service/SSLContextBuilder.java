...
public class SSLContextBuilder {
    ...
    private TrustManager[] getTrustManager() {
        TrustStoreConfig trustStoreConfig = httpConfiguration.getTrustStore();
        ...
        if (trustStoreConfig.equals(TrustStoreConfig.APPLICATION_ONLY)) {
            ...
            x509TrustManager = new CompoundTrustManager(getApplicationTrustManager(), getSystemTrustManager());
        } else {
