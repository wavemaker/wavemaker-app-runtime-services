...
public class DefaultSchemaSwitchResolver implements SchemaSwitchResolverByDBType {

    private static final Logger logger = LoggerFactory.getLogger(DefaultSchemaSwitchResolver.class);
