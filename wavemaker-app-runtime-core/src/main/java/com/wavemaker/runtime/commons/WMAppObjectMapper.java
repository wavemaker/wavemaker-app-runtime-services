...
import com.wavemaker.runtime.security.xss.XssInputSanitizationModule;
import com.wavemaker.runtime.security.xss.XssOutputSanitizationModule;
...
public class WMAppObjectMapper extends WMObjectMapper {
    ...
    private WMAppObjectMapper() {
        super();
        registerReaderModule(new XssInputSanitizationModule());
        registerWriteModule(new XssOutputSanitizationModule());
    }
}
