...
public class CASDatabaseAuthoritiesProviderCondition implements Condition {
    private static final Logger logger = LoggerFactory.getLogger(CASDatabaseAuthoritiesProviderCondition.class);
