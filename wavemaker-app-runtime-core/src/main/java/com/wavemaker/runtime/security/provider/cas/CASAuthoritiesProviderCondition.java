...
public class CASAuthoritiesProviderCondition implements Condition {
    private static final Logger logger = LoggerFactory.getLogger(CASAuthoritiesProviderCondition.class);
    ...
    public boolean matches(ConditionContext context, AnnotatedTypeMetadata metadata) {
        ...
        if (roleMappingEnabled && SecurityConstants.CAS_PROVIDER.equals(roleProvider)) {
            logger.info("Initializing CAS RoleMapping beans for CAS provider");
            return true;
        }
        return false;
    }
