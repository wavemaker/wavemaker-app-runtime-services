...
public class NoAuthoritiesPopulatorCondition implements Condition {
    private static final Logger logger = LoggerFactory.getLogger(NoAuthoritiesPopulatorCondition.class);
