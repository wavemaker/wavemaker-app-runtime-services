...
public class WMJdbcHttpSessionConfiguration extends SpringHttpSessionConfiguration
    ...
    private String tableName = WMJdbcIndexedSessionRepository.DEFAULT_TABLE_NAME;
    ...
    private List<SessionRepositoryCustomizer<WMJdbcIndexedSessionRepository>> sessionRepositoryCustomizers;
    ...
    class SessionCleanupConfiguration implements SchedulingConfigurer {
        ...
        private final WMJdbcIndexedSessionRepository sessionRepository;

        SessionCleanupConfiguration(WMJdbcIndexedSessionRepository sessionRepository) {
