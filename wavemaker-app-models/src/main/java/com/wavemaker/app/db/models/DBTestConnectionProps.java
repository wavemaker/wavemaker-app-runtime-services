...
public class DBTestConnectionProps implements Serializable, Cloneable {
    ...
    @FrameworkProfileProperty("username")
    private String username;

    @FrameworkProfileProperty("password")
    private String password;

    @NotBlank
    @FrameworkProfileProperty("url")
    private String url;

    @NotBlank
    @FrameworkProfileProperty("driverClass")
    private String driverClass;

    @NotBlank
    @FrameworkProfileProperty("dialect")
