...
public class DBConnectionProps extends DBTestConnectionProps {
    ...
    @FrameworkProfileProperty("dataSourceType")
    private DataSourceType dataSourceType;

    @FrameworkProfileProperty("jndiName")
